...
Scenario: Adding two bookmarks
  ...
  Then my bookmark list contains an entry for 'Amazon' with url 'https://www.amazon.co.uk'
  And my bookmark list contains an entry for 'Reddit' with url 'https://old.reddit.com'